...
synth_train_loader = torch.utils.data.DataLoader(synth_text_data_loader,
                                               batch_size=2,
                                               shuffle=True,
                                               num_workers=0,
                                               drop_last=True,
...
synth_images, synth_region_label, synth_affi_label, synth_confidence_mask = next(batch_synth)
