...
#
#     outpath = os.path.join(os.path.join(cfg.vis_test_dir, '{}/input'.format(str(config.ITER // 100))),
...
#
#
# def saveImage(imagename, image, bboxes, region_scores, affinity_scores, confidence_mask):
...
#
#     outpath = os.path.join(os.path.join(cfg.vis_test_dir, '{}/input'.format(str(config.ITER // 100))), imagename)
#     if not os.path.exists(os.path.dirname(outpath)):
#         os.makedirs(os.path.dirname(outpath))
#
#     cv2.imwrite(outpath, output)
